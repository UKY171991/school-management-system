            ...
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    @if(isset($general_settings) && $general_settings->logo)
                        <img src="{{ asset('storage/' . $general_settings->logo) }}?v={{ $general_settings->updated_at ? $general_settings->updated_at->timestamp : time() }}" alt="Logo" height="30" class="d-inline-block align-top me-2">
                    @endif
